...
# Actor.create(name: "Pedro Pascal", age: "45")
# Actor.create(name: "Gina Carano", age: "38")
# Actor.create(name: "Carl Weathers", age: "73")
# Actor.create(name: "Elizabeth Olsen", age: "32")
# Actor.create(name: "Paul Bettany", age: "49")
# Actor.create(name: "Kat Dennings", age: "34")
# Actor.create(name: "Emily Deschanel", age: "44")
# Actor.create(name: "David Boreanaz", age: "51")
# Actor.create(name: "Michaela Conlin", age: "42")
...
# #CHARACTERS
# Character.create(name: "Dean Winchester", bio: "Hunter and older brother of Sam Winchester.")
# Character.create(name: "Sam Winchester", bio: "Hunter and younger brother of Dean Winchester.")
# Character.create(name: "Crowley", bio: "Named "Fergus MacLeod" in life. In death became "Crowley", the king of hell.)
# Character.create(name: "Cordell Walker", bio: "A legendary Texas Ranger who just returned home after a lengthy undercover assignment.")
# Character.create(name: "Micki Ramirez", bio: "Cordell's new partner in the Texas Rangers.")
# Character.create(name: "Larry James", bio: "Captain Larry James, Cordell's former partner turned boss.")
# Character.create(name: "Din Djarin", bio: "Commonly known as "the Mandalorian" or "Mando" for short, a human male Mandalorian who worked as a bounty hunter during the New Republic Era.")
# Character.create(name: "Cara Dune", bio: "A human female Alderaanian who served as a shock trooper in the Alliance to Restore the Republic and the New Republic during the Galactic Civil War.")
# Character.create(name: "Greef Karga", bio: "A human male and former disgraced magistrate before becoming an agent of the Bounty Hunters' Guild following the collapse of the Galactic Empire.")
# Character.create(name: "Wanda Maximoff", bio: "Known as the Scarlet Witch. A Transian Sorceress and the twin sister of the speedster Quicksilver.")
# Character.create(name: "Darcy Lewis", bio: "A former student of political science at Culver University who became an intern for Erik Selvig and Jane Foster's assistant. Lewis eventually graduated with a doctorate in astrophysics.")
# Character.create(name: "Vision", bio: " An android who possesses a synthetic body (also referred to as "synthezoid") made from vibranium created by Ultron with Helen Cho's help, using the powerful artifact known as the Mind Stone to bring Vision to life. Originally conceived as the perfect form for Ultron, the body was taken by the Avengers before Tony Stark and Bruce Banner proceeded to upload the remnants of Stark's personal A.I. J.A.R.V.I.S. into it. Upon his birth, Vision declared he was neither Ultron nor J.A.R.V.I.S., but one that would fight with them to protect humanity.")
# Character.create(name: "Dr. Temperance Brennan", bio: "Temperance "Bones" Brennan, Ph.D. is an anthropologist, forensic anthropologist, and kinesiologist, she is described in the series as a leading authority in the field of forensic anthropology.")
# Character.create(name: "Seely Booth", bio: "A Special Agent with the FBI and co-protagonist of the series with Dr. Temperance Brennan, whom he affectionately refers to as "Bones".")
# Character.create(name: "Angela Montenegro", bio: "A classically trained artist who creates forensic reconstructions for the police. Also best friends with Dr. Brennan.")
